...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        TypeError: If m_a or m_b isnt a list
        TypeError: If m_a or m_b isnt a list of lists
        TypeError: If 1 element of list of lists is not an int/float
        TypeError: If row of m_a or m_b arent the same size
